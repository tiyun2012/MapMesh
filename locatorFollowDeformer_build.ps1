# powershell -ExecutionPolicy Bypass -File .\locatorFollowDeformer_build.ps1
...
$src = "$env:DEVKIT_LOCATION/devkit/plug-ins/MatchMesh/FollowDeformer"
$bld = "$env:DEVKIT_LOCATION/build/locatorFollowDeformer"
