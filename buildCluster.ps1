# powershell -ExecutionPolicy Bypass -File .\buildCluster.ps1
...
$src = "$env:DEVKIT_LOCATION/devkit/plug-ins/MatchMesh/cluster"
$bld = "$env:DEVKIT_LOCATION/build/clusterWeightFunction"
